...
import { importStudentsAction } from "@/app/(admin)/admin/classes/actions";

interface StudentCsvImportProps {
  academicYear: number;
}

export function StudentCsvImport({ academicYear }: StudentCsvImportProps) {
  ...
  async function handleImport() {
    ...
    try {
      ...
      const importResult = await importStudentsAction(formData);
  ...
  return (
    <Dialog open={open} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="max-w-2xl">
        <DialogHeader>
          <DialogTitle>生徒CSVインポート</DialogTitle>
        </DialogHeader>
